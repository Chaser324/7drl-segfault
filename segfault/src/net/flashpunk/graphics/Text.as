package net.flashpunk.graphics 
{
	...
	public class Text extends Image
	{
		...
		public function Text(text:String, x:Number = 0, y:Number = 0, options:Object = null, h:Number = 0)
		{
			...
			var height:uint = h;
			var sharpness:int = 0;
			var antialiasing:String = AntiAliasType.ADVANCED;
			...
			if (options)
			{
				...
				else
				{
					...
					if (options.hasOwnProperty("sharpness")) sharpness = options.sharpness;
					if (options.hasOwnProperty("antialiasing")) antialiasing = options.antialiasing;
				}
			}
			...
			_field.antiAliasType = antialiasing;
