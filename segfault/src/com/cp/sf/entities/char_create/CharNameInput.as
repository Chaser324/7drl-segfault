package com.cp.sf.entities.char_create 
{
	...
	public class CharNameInput extends TextInput 
	{
		...
		public function CharNameInput(x:Number=0, y:Number=0, text:String="", multiline:Boolean=false, width:Number=150, height:Number=30) 
		{
			...
			cursor = new Stamp(new BitmapData(2, 25, false, 0x111111));
		...
		{
			tf = new TextFormat("Pacifico", 20, 0x111111);
