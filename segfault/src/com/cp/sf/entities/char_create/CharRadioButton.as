package com.cp.sf.entities.char_create 
{
	 ...
	 * @author 
	 */
	public class CharRadioButton extends RadioButton 
	{
		...
		public function CharRadioButton(x:Number=0, y:Number=0, group:RadioButtonGroup=null, text:String="", width:Number=150, height:Number=50, params:Object=null, checked:Boolean=false) 
		{
